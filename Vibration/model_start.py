...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Model Start')
    parser.add_argument('--type', type=str, help='vibration current')
    parser.add_argument('--kw', type=str, help='kW')
    parser.add_argument('--machine', type=str, help='machine name')
    parser.add_argument('--state', type=str, help='state')
    parser.add_argument('--ab_state', type=str, help='ab_state')
    ...
    scaler_filename = "{machine}_{kw}_{ab_state}"
